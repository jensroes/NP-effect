...
file_out <- paste0("results/experiments/loos_exp1.csv")
...
loo_compare(loo_LMM, loo_LMM0) %>%
  ...
  select(Model, elpd_diff, se_diff) -> lmm
...
file_out <- paste0("results/experiments/loos_exp1_diff.csv")
